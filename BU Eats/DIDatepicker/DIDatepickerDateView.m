...
- (void)setDate:(NSDate *)date {
    ...
    NSMutableAttributedString *dateString = [[NSMutableAttributedString alloc]
    ...
    [dateString addAttributes:@{
        NSFontAttributeName: [UIFont systemFontOfSize:8 weight:UIFontWeightLight],
        NSForegroundColorAttributeName: UIColor.primaryTextColor
    ...
    if ([self isWeekday:date]) {
        [dateString addAttribute:NSFontAttributeName
                           value:[UIFont systemFontOfSize:8 weight:UIFontWeightSemibold]
                           range:NSMakeRange(dayFormattedString.length + 1, dayInWeekFormattedString.length)];
    }
